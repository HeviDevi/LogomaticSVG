    ...
    .then((response) => {
        let chosenShape
            if (response.shape === 'Circle') {
                 chosenShape = new Circle(response.color, response.text, response.textColor);
            } else if (response.shape === 'Square') { 
                 chosenShape = new Square(response.color, response.text, response.textColor); 
            } else if (response.shape === 'Triangle') {
                 chosenShape = new Triangle(response.color, response.text, response.textColor);
            } 
